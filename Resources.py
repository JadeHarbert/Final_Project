...
dragonim = pygame.image.load(resourcesS + "dragon.png")
fireim = pygame.image.load(resourcesS + "fireball.png")
# spiderim = pygame.image.load(resourcesS + "") ***Emily put spider boss image here
# webim = pygame.image.load(resourcesS + "") *** Emily put web bullet image here
